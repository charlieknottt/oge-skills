...
4. Audit trail — `validation_report.json` and `generation_log.md` (the reason behind each choice).
5. Optional — `<scenario>.html`, a self-contained **playable** demo of the graph propagating, for
