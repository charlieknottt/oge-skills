...
## Task
Work the **nine questions** (guide/1-how-the-model-works.md) against the scenario *for your
...
behavior `Lever`) are exempt from "something moves it": they have no incoming edges and move only
...
```json
{
  ...
  "stocks": [ { "id": "...", "name": "...", "pmesii": "Economic", "stock_type": "...",
               "type": "...", "inverted": false, "node_value": 0.6,
               "measures": "...", "unit": "...",
